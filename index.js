let HotPotato = require('./Problemas/Queue/HotPotato.js');

let list =['Filipe','Rodrigo', 'Iolanda','Hercules'];
console.log(HotPotato.start(list, Math.floor(Math.random()*list.length)));
